...
def color_calibration(src, dst, colorspace = sRGB,
        ccm_shape = '4x3', 
        distance = 'de00', 
        linear = 'gamma', gamma = 2.2, deg = 2, 
        saturated_threshold = (0, 1), weights_list = None, weights_coeff = 0, 
        initial_method = 'white_balance', xtol = 1e-4, ftol = 1e-4, only_infer = False):
    ...
    return globals()['CCM_'+ccm_shape](src, dst, colorspace,
        ...
        initial_method, xtol, ftol, only_infer)
